"""
Django settings for greg_test_101 project.
...
ROOT_URLCONF = 'greg_test_101.urls'
...
WSGI_APPLICATION = 'greg_test_101.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Greg Test Support <support@greg-test-101.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greg_test_101 API",
    "DESCRIPTION": "API documentation for greg_test_101 App",
    "VERSION": "v1",
}
